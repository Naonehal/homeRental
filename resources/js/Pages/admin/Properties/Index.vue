                            ...
                            <table className="table-auto w-full">
                                <thead>
                                    <tr className="bg-gray-100">
                                        ...
                                        <th className="px-4 py-2 w-[96rem]">Description</th>

                                        <th className="px-4 py-2 w-8 ">Bed/Bath</th>
                                ...
                                <tbody>
                                    <tr v-for="(property, index) in props.properties" :key="index">
                                        ...
                                        <td className="border px-4 py-3 text-center">
                                            ...
                                            <button @click="destroy(property.id)" type="button"
